...
print(r1 == r2)
sumar_lamda2 = lambda x, y : calcular_algo_complejo() # De esta manera, podría definir funciones lamda de más de una línea de código, pouesto que en su única línea de código estoy invocando una función que sí que tiene más de una línea.
